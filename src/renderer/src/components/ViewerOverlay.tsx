...
function ViewerOverlayComponent({
  ...
  return (
    ...
    >
      <aside
        className="glass-panel absolute inset-y-4 left-4 flex w-[min(60vw,920px)] min-w-[640px] flex-col overflow-hidden rounded-[var(--radius-surface)] border border-[color:var(--line-strong)] shadow-[0_28px_80px_rgba(0,0,0,0.34)]"
        onClick={(event) => event.stopPropagation()}
      >
        <div className="border-b border-[color:var(--line)] bg-[linear-gradient(180deg,color-mix(in_srgb,var(--surface-1)_92%,transparent),var(--surface-0))] px-5 pb-4 pt-5">
          <div className="flex items-start justify-between gap-5">
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2">
                ...
                <div className="rounded-[999px] border border-[color:var(--line)] bg-[var(--surface-0)] px-2 py-0.5 text-[9px] font-semibold uppercase tracking-[0.16em] text-[var(--text-dim)]">
                  {viewerKindLabel(file)}
                </div>
              </div>
              <div className="mt-3 truncate px-0.5 pb-0.5 text-[1.6rem] font-semibold leading-[1.05] tracking-[-0.035em] text-[var(--text)]">
                {file.name}
              </div>
              <div className="mt-3 flex max-w-[30rem] items-center gap-2 rounded-[var(--radius-control)] border border-[color:var(--line)] bg-[color:var(--surface-overlay)] px-3 py-2">
                <div className="shrink-0 text-[9px] font-semibold uppercase tracking-[0.16em] text-[var(--text-faint)]">
                  Source
                </div>
